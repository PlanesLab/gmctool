...
tabPanel(title = "4. Visualization",
         ...
         sidebarLayout(
           ...
           mainPanel(width = 9,
                     ...
                     fluidRow(
                       column(width = 5, selectInput(inputId = "I_RESULT_TABLE_GMCS_SINGLE_DOUBLE",
                                                     label = "Select which results to show:", 
                                                     choices =  list("Single KO", "Double KO (only)", "Double KO + single KOs"), 
                                                     selected = "Single KO")
                       ),
                       column(width = 5, radioButtons(inputId = "I_RESULT_TABLE_GMCS_MODE", 
                       ...
                       column(width = 2,
                              actionButton("I_mp4_calculate_force", 
